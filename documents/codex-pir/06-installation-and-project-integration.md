...
它负责建立项目中的最小可用 Codex 工作骨架，并将精简版 `superpowers` workflow 一起带入项目。
...
- `vendor/superpowers/skills/` 精简 workflow
- 文档入口与说明
...
- roles / workflows / configuration / prompts
- 安装与初始化资产说明
